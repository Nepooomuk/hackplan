...
var _local$local$Main$iconTaskInactive = A2(
	...
	{
		ctor: '::',
		_0: A2(_debois$elm_mdl$Material_Options$css, 'vertical-align', 'text-bottom'),
		_1: {
			ctor: '::',
...
var _local$local$Main$iconTaskActive = A2(
	_debois$elm_mdl$Material_Icon$view,
	'timer',
	{
		ctor: '::',
...
var _local$local$Main$alignCenter = A2(_debois$elm_mdl$Material_Options$css, 'text-align', 'center');
var _local$local$Main$alignRight = A2(_debois$elm_mdl$Material_Options$css, 'text-align', 'right');
var _local$local$Main$alignLeft = A2(_debois$elm_mdl$Material_Options$css, 'text-align', 'left');
var _local$local$Main$viewTasksHeader = A2(
...
var _local$local$Main$boxed = {
	...
	_1: {
		ctor: '::',
		_0: A2(_debois$elm_mdl$Material_Options$css, 'padding-bottom', '1%'),
		_1: {
			ctor: '::',
			_0: A2(_debois$elm_mdl$Material_Options$css, 'padding-left', '4%'),
			_1: {
				ctor: '::',
				_0: A2(_debois$elm_mdl$Material_Options$css, 'padding-right', '4%'),
				_1: {
					ctor: '::',
...
var _local$local$Main$viewSearchPanel = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onSubmit(_local$local$Main$Search),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			...
			_1: {
				...
				_0: A5(
					...
					{
						ctor: '::',
						_0: _debois$elm_mdl$Material_Options$onClick(_local$local$Main$Search),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
	...
	if (_p1.ctor === 'Nothing') {
		...
		return A2(
			_debois$elm_mdl$Material_Chip$span,
			{
				...
				_1: {
					ctor: '::',
					_0: _debois$elm_mdl$Material_Chip$deleteClick(_local$local$Main$ClearError),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _local$local$Main$page = function (model) {
	return A2(
		_debois$elm_mdl$Material_Options$div,
		_local$local$Main$boxed,
		{
			ctor: '::',
			_0: _local$local$Main$viewErrorPanel(model.error),
			_1: {
				ctor: '::',
...
var _local$local$Main$view = function (model) {
	return A4(
		...
		},
		{
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Hack-Plan 2017'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
			...
			main: {
				ctor: '::',
				_0: _local$local$Main$page(model),
				_1: {ctor: '[]'}
			}
		});
};
var _local$local$Main$main = _elm_lang$html$Html$program(
	{
		init: {
			ctor: '_Tuple2',
		...
		view: _local$local$Main$view
	})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _local$local$Main$main !== 'undefined') {
    _local$local$Main$main(Elm['Main'], 'Main', undefined);
}
